...
class Children extends React.Component {
    ...
    childrenBooks = () => {
        return this.props.books.booksList === [] ? null : this.props.books.booksList.filter(book => {
            return (book.genre.name === "Children") && (book.language === this.props.language)
        })
    }
        ...
        return (
            <div className="booksList">
                {(this.props.searchTerm === '') ?
                    ...
                    <div>
                        <span><p className="section-header">{(this.props.language === "عربى") || (this.props.language === "اردو") ? "أطفال" : "Children"}</p></span><br />
...
export default connect(mapStateToProps, { fetchAllBooks, getReauth })(Children)